...
export const tikoI18nKeys = {
  yesNo: {
    ...
    settings: {
      ...
      labelSize: 'yesNo.settings.labelSize',
    },
    question: {
    ...
    sheet: {
      newSet: 'yesNo.sheet.newSet',
      editSet: 'yesNo.sheet.editSet',
      setName: 'yesNo.sheet.setName',
      setNamePlaceholder: 'yesNo.sheet.setNamePlaceholder',
      description: 'yesNo.sheet.description',
      descriptionPlaceholder: 'yesNo.sheet.descriptionPlaceholder',
      color: 'yesNo.sheet.color',
      image: 'yesNo.sheet.image',
      changeImage: 'yesNo.sheet.changeImage',
      addImage: 'yesNo.sheet.addImage',
      pickImage: 'yesNo.sheet.pickImage',
      search: 'yesNo.sheet.search',
      searching: 'yesNo.sheet.searching',
      searchImages: 'yesNo.sheet.searchImages',
      typeToSearch: 'yesNo.sheet.typeToSearch',
      cancel: 'yesNo.sheet.cancel',
      addSet: 'yesNo.sheet.addSet',
      tiles: 'yesNo.sheet.tiles',
      tilesEmpty: 'yesNo.sheet.tilesEmpty',
      tileCount: 'yesNo.sheet.tileCount',
      select: 'yesNo.sheet.select',
      delete: 'yesNo.sheet.delete',
      readonlySet: 'yesNo.sheet.readonlySet',
      newTile: 'yesNo.sheet.newTile',
      editTile: 'yesNo.sheet.editTile',
      name: 'yesNo.sheet.name',
      namePlaceholder: 'yesNo.sheet.namePlaceholder',
      spokenText: 'yesNo.sheet.spokenText',
      whatShouldBeSpoken: 'yesNo.sheet.whatShouldBeSpoken',
    },
    status: {
  ...
  radio: {
    ...
    collections: {
      title: 'radio.collections.title',
      songs: 'radio.collections.songs',
      empty: 'radio.collections.empty',
      name: 'radio.collections.name',
      artwork: 'radio.collections.artwork',
      artworkSearch: 'radio.collections.artworkSearch',
      artworkEmpty: 'radio.collections.artworkEmpty',
      color: 'radio.collections.color',
    },
    add: {
      menuTitle: 'radio.add.menuTitle',
      song: 'radio.add.song',
      collection: 'radio.add.collection',
      searchYouTube: 'radio.add.searchYouTube',
      searchPlaceholder: 'radio.add.searchPlaceholder',
      searchEmpty: 'radio.add.searchEmpty',
      searchUnavailable: 'radio.add.searchUnavailable',
      pasteLink: 'radio.add.pasteLink',
      pasteLinkPlaceholder: 'radio.add.pasteLinkPlaceholder',
      pasteServiceLink: 'radio.add.pasteServiceLink',
      pasteServiceLinkPlaceholder: 'radio.add.pasteServiceLinkPlaceholder',
      uploadTitle: 'radio.add.uploadTitle',
      uploadHint: 'radio.add.uploadHint',
      chooseFile: 'radio.add.chooseFile',
      toCollection: 'radio.add.toCollection',
      addSong: 'radio.add.addSong',
      audioOnly: 'radio.add.audioOnly',
      linkNotRecognised: 'radio.add.linkNotRecognised',
    },
    management: {
      ...
      editCollection: 'radio.management.editCollection',
      deleteCollection: 'radio.management.deleteCollection',
      deleteCollectionWarning: 'radio.management.deleteCollectionWarning',
      deleteCollectionWarningEmpty: 'radio.management.deleteCollectionWarningEmpty',
      collectionActions: 'radio.management.collectionActions',
    },
    share: {
      title: 'radio.share.title',
      subtitle: 'radio.share.subtitle',
      publishing: 'radio.share.publishing',
      codeLabel: 'radio.share.codeLabel',
      copyLink: 'radio.share.copyLink',
      copied: 'radio.share.copied',
      skipped: 'radio.share.skipped',
      failed: 'radio.share.failed',
      shareCollection: 'radio.share.shareCollection',
    },
    import: {
      title: 'radio.import.title',
      subtitle: 'radio.import.subtitle',
      scan: 'radio.import.scan',
      scanHint: 'radio.import.scanHint',
      scanUnsupported: 'radio.import.scanUnsupported',
      cameraBlocked: 'radio.import.cameraBlocked',
      codeLabel: 'radio.import.codeLabel',
      codePlaceholder: 'radio.import.codePlaceholder',
      find: 'radio.import.find',
      notFound: 'radio.import.notFound',
      featured: 'radio.import.featured',
      addCollection: 'radio.import.addCollection',
    },
    services: {
      title: 'radio.services.title',
      subtitle: 'radio.services.subtitle',
      link: 'radio.services.link',
      unlink: 'radio.services.unlink',
      linked: 'radio.services.linked',
      spotify: 'radio.services.spotify',
      spotifyHint: 'radio.services.spotifyHint',
      appleMusic: 'radio.services.appleMusic',
      appleMusicHint: 'radio.services.appleMusicHint',
      addFrom: 'radio.services.addFrom',
      opensInService: 'radio.services.opensInService',
    },
    parentMode: {
...
const yesNoEnglish: TranslationMap = {
  ...
  [tikoI18nKeys.yesNo.settings.labelSize]: 'Label size',
  ...
  [tikoI18nKeys.yesNo.sheet.newSet]: 'New answer set',
  [tikoI18nKeys.yesNo.sheet.editSet]: 'Edit answer set',
  [tikoI18nKeys.yesNo.sheet.setName]: 'Set name',
  [tikoI18nKeys.yesNo.sheet.setNamePlaceholder]: 'Name this set',
  [tikoI18nKeys.yesNo.sheet.description]: 'Description',
  [tikoI18nKeys.yesNo.sheet.descriptionPlaceholder]: 'Optional description',
  [tikoI18nKeys.yesNo.sheet.color]: 'Color',
  [tikoI18nKeys.yesNo.sheet.image]: 'Image',
  [tikoI18nKeys.yesNo.sheet.changeImage]: 'Change image',
  [tikoI18nKeys.yesNo.sheet.addImage]: 'Add image',
  [tikoI18nKeys.yesNo.sheet.pickImage]: 'Choose image',
  [tikoI18nKeys.yesNo.sheet.search]: 'Search',
  [tikoI18nKeys.yesNo.sheet.searching]: 'Searching…',
  [tikoI18nKeys.yesNo.sheet.searchImages]: 'Search images',
  [tikoI18nKeys.yesNo.sheet.typeToSearch]: 'Type to search for images',
  [tikoI18nKeys.yesNo.sheet.cancel]: 'Cancel',
  [tikoI18nKeys.yesNo.sheet.addSet]: 'Add set',
  [tikoI18nKeys.yesNo.sheet.tiles]: 'Tiles',
  [tikoI18nKeys.yesNo.sheet.tilesEmpty]: 'No tiles yet. Add one to build the set.',
  [tikoI18nKeys.yesNo.sheet.tileCount]: 'tiles',
  [tikoI18nKeys.yesNo.sheet.select]: 'Use this set',
  [tikoI18nKeys.yesNo.sheet.delete]: 'Delete',
  [tikoI18nKeys.yesNo.sheet.readonlySet]: 'This is a built-in set. Create your own set to edit tiles.',
  [tikoI18nKeys.yesNo.sheet.newTile]: 'New answer',
  [tikoI18nKeys.yesNo.sheet.editTile]: 'Edit answer',
  [tikoI18nKeys.yesNo.sheet.name]: 'Answer',
  [tikoI18nKeys.yesNo.sheet.namePlaceholder]: 'What to display',
  [tikoI18nKeys.yesNo.sheet.spokenText]: 'Spoken text',
  [tikoI18nKeys.yesNo.sheet.whatShouldBeSpoken]: 'What to say when tapped',
...
const yesNoFrench: TranslationMap = {
  ...
  [tikoI18nKeys.yesNo.settings.labelSize]: 'Taille des étiquettes',
  ...
  [tikoI18nKeys.yesNo.sheet.newSet]: 'Nouveau jeu de réponses',
  [tikoI18nKeys.yesNo.sheet.editSet]: 'Modifier le jeu de réponses',
  [tikoI18nKeys.yesNo.sheet.setName]: 'Nom du jeu',
  [tikoI18nKeys.yesNo.sheet.setNamePlaceholder]: 'Nommer ce jeu',
  [tikoI18nKeys.yesNo.sheet.description]: 'Description',
  [tikoI18nKeys.yesNo.sheet.descriptionPlaceholder]: 'Description facultative',
  [tikoI18nKeys.yesNo.sheet.color]: 'Couleur',
  [tikoI18nKeys.yesNo.sheet.image]: 'Image',
  [tikoI18nKeys.yesNo.sheet.changeImage]: 'Changer l’image',
  [tikoI18nKeys.yesNo.sheet.addImage]: 'Ajouter une image',
  [tikoI18nKeys.yesNo.sheet.pickImage]: 'Choisir une image',
  [tikoI18nKeys.yesNo.sheet.search]: 'Rechercher',
  [tikoI18nKeys.yesNo.sheet.searching]: 'Recherche…',
  [tikoI18nKeys.yesNo.sheet.searchImages]: 'Rechercher des images',
  [tikoI18nKeys.yesNo.sheet.typeToSearch]: 'Saisis pour rechercher des images',
  [tikoI18nKeys.yesNo.sheet.cancel]: 'Annuler',
  [tikoI18nKeys.yesNo.sheet.addSet]: 'Ajouter un jeu',
  [tikoI18nKeys.yesNo.sheet.tiles]: 'Tuiles',
  [tikoI18nKeys.yesNo.sheet.tilesEmpty]: 'Aucune tuile. Ajoute-en une pour construire le jeu.',
  [tikoI18nKeys.yesNo.sheet.tileCount]: 'tuiles',
  [tikoI18nKeys.yesNo.sheet.select]: 'Utiliser ce jeu',
  [tikoI18nKeys.yesNo.sheet.delete]: 'Supprimer',
  [tikoI18nKeys.yesNo.sheet.readonlySet]: 'Jeu intégré. Crée ton propre jeu pour modifier les tuiles.',
  [tikoI18nKeys.yesNo.sheet.newTile]: 'Nouvelle réponse',
  [tikoI18nKeys.yesNo.sheet.editTile]: 'Modifier la réponse',
  [tikoI18nKeys.yesNo.sheet.name]: 'Réponse',
  [tikoI18nKeys.yesNo.sheet.namePlaceholder]: 'À afficher',
  [tikoI18nKeys.yesNo.sheet.spokenText]: 'Texte prononcé',
  [tikoI18nKeys.yesNo.sheet.whatShouldBeSpoken]: 'À dire lorsqu’on appuie',
...
const yesNoDutch: TranslationMap = {
  ...
  [tikoI18nKeys.yesNo.settings.labelSize]: 'Labelgrootte',
  ...
  [tikoI18nKeys.yesNo.sheet.newSet]: 'Nieuwe antwoordset',
  [tikoI18nKeys.yesNo.sheet.editSet]: 'Antwoordset bewerken',
  [tikoI18nKeys.yesNo.sheet.setName]: 'Naam van set',
  [tikoI18nKeys.yesNo.sheet.setNamePlaceholder]: 'Benoem deze set',
  [tikoI18nKeys.yesNo.sheet.description]: 'Omschrijving',
  [tikoI18nKeys.yesNo.sheet.descriptionPlaceholder]: 'Optionele omschrijving',
  [tikoI18nKeys.yesNo.sheet.color]: 'Kleur',
  [tikoI18nKeys.yesNo.sheet.image]: 'Afbeelding',
  [tikoI18nKeys.yesNo.sheet.changeImage]: 'Afbeelding wijzigen',
  [tikoI18nKeys.yesNo.sheet.addImage]: 'Afbeelding toevoegen',
  [tikoI18nKeys.yesNo.sheet.pickImage]: 'Afbeelding kiezen',
  [tikoI18nKeys.yesNo.sheet.search]: 'Zoeken',
  [tikoI18nKeys.yesNo.sheet.searching]: 'Zoeken…',
  [tikoI18nKeys.yesNo.sheet.searchImages]: 'Afbeeldingen zoeken',
  [tikoI18nKeys.yesNo.sheet.typeToSearch]: 'Typ om afbeeldingen te zoeken',
  [tikoI18nKeys.yesNo.sheet.cancel]: 'Annuleren',
  [tikoI18nKeys.yesNo.sheet.addSet]: 'Set toevoegen',
  [tikoI18nKeys.yesNo.sheet.tiles]: 'Tegels',
  [tikoI18nKeys.yesNo.sheet.tilesEmpty]: 'Nog geen tegels. Voeg er een toe om de set te bouwen.',
  [tikoI18nKeys.yesNo.sheet.tileCount]: 'tegels',
  [tikoI18nKeys.yesNo.sheet.select]: 'Deze set gebruiken',
  [tikoI18nKeys.yesNo.sheet.delete]: 'Verwijderen',
  [tikoI18nKeys.yesNo.sheet.readonlySet]: 'Dit is een ingebouwde set. Maak een eigen set om tegels te bewerken.',
  [tikoI18nKeys.yesNo.sheet.newTile]: 'Nieuw antwoord',
  [tikoI18nKeys.yesNo.sheet.editTile]: 'Antwoord bewerken',
  [tikoI18nKeys.yesNo.sheet.name]: 'Antwoord',
  [tikoI18nKeys.yesNo.sheet.namePlaceholder]: 'Wat te tonen',
  [tikoI18nKeys.yesNo.sheet.spokenText]: 'Uitgesproken tekst',
  [tikoI18nKeys.yesNo.sheet.whatShouldBeSpoken]: 'Wat te zeggen bij aanraking',
  [tikoI18nKeys.yesNo.status.browserVoiceFallback]: 'Browser voice used',
}
...
const yesNoSpanish: TranslationMap = {
  ...
  [tikoI18nKeys.yesNo.settings.labelSize]: 'Tamaño de etiqueta',
  ...
  [tikoI18nKeys.yesNo.sheet.newSet]: 'Nuevo conjunto de respuestas',
  [tikoI18nKeys.yesNo.sheet.editSet]: 'Editar conjunto de respuestas',
  [tikoI18nKeys.yesNo.sheet.setName]: 'Nombre del conjunto',
  [tikoI18nKeys.yesNo.sheet.setNamePlaceholder]: 'Nombrar este conjunto',
  [tikoI18nKeys.yesNo.sheet.description]: 'Descripción',
  [tikoI18nKeys.yesNo.sheet.descriptionPlaceholder]: 'Descripción opcional',
  [tikoI18nKeys.yesNo.sheet.color]: 'Color',
  [tikoI18nKeys.yesNo.sheet.image]: 'Imagen',
  [tikoI18nKeys.yesNo.sheet.changeImage]: 'Cambiar imagen',
  [tikoI18nKeys.yesNo.sheet.addImage]: 'Añadir imagen',
  [tikoI18nKeys.yesNo.sheet.pickImage]: 'Elegir imagen',
  [tikoI18nKeys.yesNo.sheet.search]: 'Buscar',
  [tikoI18nKeys.yesNo.sheet.searching]: 'Buscando…',
  [tikoI18nKeys.yesNo.sheet.searchImages]: 'Buscar imágenes',
  [tikoI18nKeys.yesNo.sheet.typeToSearch]: 'Escribe para buscar imágenes',
  [tikoI18nKeys.yesNo.sheet.cancel]: 'Cancelar',
  [tikoI18nKeys.yesNo.sheet.addSet]: 'Añadir conjunto',
  [tikoI18nKeys.yesNo.sheet.tiles]: 'Tarjetas',
  [tikoI18nKeys.yesNo.sheet.tilesEmpty]: 'Aún no hay tarjetas. Añade una para crear el conjunto.',
  [tikoI18nKeys.yesNo.sheet.tileCount]: 'tarjetas',
  [tikoI18nKeys.yesNo.sheet.select]: 'Usar este conjunto',
  [tikoI18nKeys.yesNo.sheet.delete]: 'Eliminar',
  [tikoI18nKeys.yesNo.sheet.readonlySet]: 'Conjunto integrado. Crea tu propio conjunto para editar tarjetas.',
  [tikoI18nKeys.yesNo.sheet.newTile]: 'Nueva respuesta',
  [tikoI18nKeys.yesNo.sheet.editTile]: 'Editar respuesta',
  [tikoI18nKeys.yesNo.sheet.name]: 'Respuesta',
  [tikoI18nKeys.yesNo.sheet.namePlaceholder]: 'Qué mostrar',
  [tikoI18nKeys.yesNo.sheet.spokenText]: 'Texto hablado',
  [tikoI18nKeys.yesNo.sheet.whatShouldBeSpoken]: 'Qué decir al pulsar',
...
const yesNoMaltese: TranslationMap = {
  ...
  [tikoI18nKeys.yesNo.settings.answerTilesDefault]: 'Default',
  [tikoI18nKeys.yesNo.settings.labelSize]: 'Daqs tat-tikketta',
  ...
  [tikoI18nKeys.yesNo.sheet.newSet]: 'Set ġdid ta’ tweġibiet',
  [tikoI18nKeys.yesNo.sheet.editSet]: 'Edita s-set ta’ tweġibiet',
  [tikoI18nKeys.yesNo.sheet.setName]: 'Isem is-set',
  [tikoI18nKeys.yesNo.sheet.setNamePlaceholder]: 'Semmi dan is-set',
  [tikoI18nKeys.yesNo.sheet.description]: 'Deskrizzjoni',
  [tikoI18nKeys.yesNo.sheet.descriptionPlaceholder]: 'Deskrizzjoni opzjonali',
  [tikoI18nKeys.yesNo.sheet.color]: 'Kulur',
  [tikoI18nKeys.yesNo.sheet.image]: 'Stampa',
  [tikoI18nKeys.yesNo.sheet.changeImage]: 'Biddel stampa',
  [tikoI18nKeys.yesNo.sheet.addImage]: 'Żid stampa',
  [tikoI18nKeys.yesNo.sheet.pickImage]: 'Agħżel stampa',
  [tikoI18nKeys.yesNo.sheet.search]: 'Fittex',
  [tikoI18nKeys.yesNo.sheet.searching]: 'Qed jiftex…',
  [tikoI18nKeys.yesNo.sheet.searchImages]: 'Fittex stampi',
  [tikoI18nKeys.yesNo.sheet.typeToSearch]: 'Ikteb biex tfittex stampi',
  [tikoI18nKeys.yesNo.sheet.cancel]: 'Annulla',
  [tikoI18nKeys.yesNo.sheet.addSet]: 'Żid set',
  [tikoI18nKeys.yesNo.sheet.tiles]: 'Madum',
  [tikoI18nKeys.yesNo.sheet.tilesEmpty]: 'Għadu ma hemmx madum. Żid wieħed biex tibni s-set.',
  [tikoI18nKeys.yesNo.sheet.tileCount]: 'madum',
  [tikoI18nKeys.yesNo.sheet.select]: 'Uża dan is-set',
  [tikoI18nKeys.yesNo.sheet.delete]: 'Ħassar',
  [tikoI18nKeys.yesNo.sheet.readonlySet]: 'Set integrat. Oħloq set tiegħek biex teditja l-madum.',
  [tikoI18nKeys.yesNo.sheet.newTile]: 'Tweġiba ġdida',
  [tikoI18nKeys.yesNo.sheet.editTile]: 'Edita tweġiba',
  [tikoI18nKeys.yesNo.sheet.name]: 'Tweġiba',
  [tikoI18nKeys.yesNo.sheet.namePlaceholder]: 'X’jidher',
  [tikoI18nKeys.yesNo.sheet.spokenText]: 'Test mitkellem',
  [tikoI18nKeys.yesNo.sheet.whatShouldBeSpoken]: 'X’se tgħid meta tagħfas',
...
const radioEnglish: TranslationMap = {
  ...
  [tikoI18nKeys.radio.collections.title]: 'Collections',
  [tikoI18nKeys.radio.collections.songs]: '{count} songs',
  [tikoI18nKeys.radio.collections.empty]: 'No songs yet',
  [tikoI18nKeys.radio.collections.name]: 'Collection name',
  [tikoI18nKeys.radio.collections.artwork]: 'Picture',
  [tikoI18nKeys.radio.collections.artworkSearch]: 'Search Tiko pictures',
  [tikoI18nKeys.radio.collections.artworkEmpty]: 'No pictures found',
  [tikoI18nKeys.radio.collections.color]: 'Colour',
  [tikoI18nKeys.radio.add.menuTitle]: 'What do you want to add?',
  [tikoI18nKeys.radio.add.song]: 'Add song',
  [tikoI18nKeys.radio.add.collection]: 'Add collection',
  [tikoI18nKeys.radio.add.searchYouTube]: 'Search YouTube',
  [tikoI18nKeys.radio.add.searchPlaceholder]: 'Search for songs, stories\u2026',
  [tikoI18nKeys.radio.add.searchEmpty]: 'Nothing found. Try other words.',
  [tikoI18nKeys.radio.add.searchUnavailable]: 'Search is unavailable right now \u2014 paste a link instead.',
  [tikoI18nKeys.radio.add.pasteLink]: 'Paste a YouTube link',
  [tikoI18nKeys.radio.add.pasteLinkPlaceholder]: 'https://youtube.com/\u2026',
  [tikoI18nKeys.radio.add.pasteServiceLink]: 'Paste a song link',
  [tikoI18nKeys.radio.add.pasteServiceLinkPlaceholder]: 'https://open.spotify.com/track/\u2026',
  [tikoI18nKeys.radio.add.uploadTitle]: 'Upload audio',
  [tikoI18nKeys.radio.add.uploadHint]: 'MP3, WAV, M4A',
  [tikoI18nKeys.radio.add.chooseFile]: 'Tap to choose an audio file',
  [tikoI18nKeys.radio.add.toCollection]: 'Add to {collection}',
  [tikoI18nKeys.radio.add.addSong]: 'Add song',
  [tikoI18nKeys.radio.add.audioOnly]: 'Only the sound plays \u2014 the video stays hidden.',
  [tikoI18nKeys.radio.add.linkNotRecognised]: 'That link is not a song Radio can play.',
  [tikoI18nKeys.radio.management.editCollection]: 'Edit collection',
  [tikoI18nKeys.radio.management.deleteCollection]: 'Delete collection',
  [tikoI18nKeys.radio.management.deleteCollectionWarning]: 'Deleting \u201c{collection}\u201d also removes its {count} songs.',
  [tikoI18nKeys.radio.management.deleteCollectionWarningEmpty]: 'Delete \u201c{collection}\u201d?',
  [tikoI18nKeys.radio.management.collectionActions]: 'Collection options',
  [tikoI18nKeys.radio.share.title]: 'Share this collection',
  [tikoI18nKeys.radio.share.subtitle]: 'Let another family scan this, or read them the code.',
  [tikoI18nKeys.radio.share.publishing]: 'Making a code\u2026',
  [tikoI18nKeys.radio.share.codeLabel]: 'Share code',
  [tikoI18nKeys.radio.share.copyLink]: 'Copy link',
  [tikoI18nKeys.radio.share.copied]: 'Link copied',
  [tikoI18nKeys.radio.share.skipped]: '{count} songs were left out because they only live on this device.',
  [tikoI18nKeys.radio.share.failed]: 'This collection could not be shared.',
  [tikoI18nKeys.radio.share.shareCollection]: 'Share collection',
  [tikoI18nKeys.radio.import.title]: 'Add a shared collection',
  [tikoI18nKeys.radio.import.subtitle]: 'Scan a Tiko code, or type the eight characters under it.',
  [tikoI18nKeys.radio.import.scan]: 'Scan a code',
  [tikoI18nKeys.radio.import.scanHint]: 'Hold the code in front of the camera.',
  [tikoI18nKeys.radio.import.scanUnsupported]: 'This browser cannot scan. Use the phone camera on the code, or type it below.',
  [tikoI18nKeys.radio.import.cameraBlocked]: 'The camera is not available. Type the code instead.',
  [tikoI18nKeys.radio.import.codeLabel]: 'Share code',
  [tikoI18nKeys.radio.import.codePlaceholder]: 'ABCD 2345',
  [tikoI18nKeys.radio.import.find]: 'Find',
  [tikoI18nKeys.radio.import.notFound]: 'No collection was found for that code.',
  [tikoI18nKeys.radio.import.featured]: 'Ready-made collections',
  [tikoI18nKeys.radio.import.addCollection]: 'Add this collection',
  [tikoI18nKeys.radio.services.title]: 'Music services',
  [tikoI18nKeys.radio.services.subtitle]: 'Link a subscription to add its songs to a collection.',
  [tikoI18nKeys.radio.services.link]: 'Link',
  [tikoI18nKeys.radio.services.unlink]: 'Unlink',
  [tikoI18nKeys.radio.services.linked]: 'Linked',
  [tikoI18nKeys.radio.services.spotify]: 'Spotify',
  [tikoI18nKeys.radio.services.spotifyHint]: 'Songs play in Radio through Spotify\u2019s own player. Sign in to Spotify in this browser to hear full songs instead of previews.',
  [tikoI18nKeys.radio.services.appleMusic]: 'Apple Music',
  [tikoI18nKeys.radio.services.appleMusicHint]: 'Apple Music songs open in Apple Music \u2014 Radio cannot play them itself.',
  [tikoI18nKeys.radio.services.addFrom]: 'Add from {service}',
  [tikoI18nKeys.radio.services.opensInService]: 'Opens in {service}',
...
const radioMaltese: TranslationMap = {
  ...
  [tikoI18nKeys.radio.collections.title]: 'Kollezzjonijiet',
  [tikoI18nKeys.radio.collections.songs]: '{count} kanzunetti',
  [tikoI18nKeys.radio.collections.empty]: 'Ghad mhemmx kanzunetti',
  [tikoI18nKeys.radio.collections.name]: 'Isem il-kollezzjoni',
  [tikoI18nKeys.radio.collections.artwork]: 'Ritratt',
  [tikoI18nKeys.radio.collections.artworkSearch]: 'Fittex ritratti ta Tiko',
  [tikoI18nKeys.radio.collections.artworkEmpty]: 'Ma nstab ebda ritratt',
  [tikoI18nKeys.radio.collections.color]: 'Kulur',
  [tikoI18nKeys.radio.add.menuTitle]: 'Xi trid izzid?',
  [tikoI18nKeys.radio.add.song]: 'Zid kanzunetta',
  [tikoI18nKeys.radio.add.collection]: 'Zid kollezzjoni',
  [tikoI18nKeys.radio.add.searchYouTube]: 'Fittex fuq YouTube',
  [tikoI18nKeys.radio.add.searchPlaceholder]: 'Fittex kanzunetti jew stejjer\u2026',
  [tikoI18nKeys.radio.add.searchEmpty]: 'Ma nstab xejn. Ipprova kliem iehor.',
  [tikoI18nKeys.radio.add.searchUnavailable]: 'It-tfittxija mhix disponibbli bhalissa \u2014 wahhal link minflok.',
  [tikoI18nKeys.radio.add.pasteLink]: 'Wahhal link ta YouTube',
  [tikoI18nKeys.radio.add.pasteLinkPlaceholder]: 'https://youtube.com/\u2026',
  [tikoI18nKeys.radio.add.pasteServiceLink]: 'Wahhal link ta kanzunetta',
  [tikoI18nKeys.radio.add.pasteServiceLinkPlaceholder]: 'https://open.spotify.com/track/\u2026',
  [tikoI18nKeys.radio.add.uploadTitle]: 'Tella awdjo',
  [tikoI18nKeys.radio.add.uploadHint]: 'MP3, WAV, M4A',
  [tikoI18nKeys.radio.add.chooseFile]: 'Aghfas biex taghzel fajl tal-awdjo',
  [tikoI18nKeys.radio.add.toCollection]: 'Zid ma {collection}',
  [tikoI18nKeys.radio.add.addSong]: 'Zid kanzunetta',
  [tikoI18nKeys.radio.add.audioOnly]: 'Jindaqq il-hoss biss \u2014 il-vidjow jibqa mohbi.',
  [tikoI18nKeys.radio.add.linkNotRecognised]: 'Dak il-link mhux kanzunetta li Radju jista jdoqq.',
  [tikoI18nKeys.radio.management.editCollection]: 'Editja l-kollezzjoni',
  [tikoI18nKeys.radio.management.deleteCollection]: 'Hassar il-kollezzjoni',
  [tikoI18nKeys.radio.management.deleteCollectionWarning]: 'Jekk thassar \u201c{collection}\u201d jitilfu wkoll il-{count} kanzunetti taghha.',
  [tikoI18nKeys.radio.management.deleteCollectionWarningEmpty]: 'Thassar \u201c{collection}\u201d?',
  [tikoI18nKeys.radio.management.collectionActions]: 'Ghazliet tal-kollezzjoni',
  [tikoI18nKeys.radio.share.title]: 'Aqsam din il-kollezzjoni',
  [tikoI18nKeys.radio.share.subtitle]: 'Halli familja ohra tiskennja dan, jew aqralhom il-kodici.',
  [tikoI18nKeys.radio.share.publishing]: 'Qed isir kodici\u2026',
  [tikoI18nKeys.radio.share.codeLabel]: 'Kodici tal-qsim',
  [tikoI18nKeys.radio.share.copyLink]: 'Ikkopja l-link',
  [tikoI18nKeys.radio.share.copied]: 'Il-link giet ikkupjata',
  [tikoI18nKeys.radio.share.skipped]: '{count} kanzunetti tħallew barra ghax jinsabu biss fuq dan l-apparat.',
  [tikoI18nKeys.radio.share.failed]: 'Din il-kollezzjoni ma setghetx tinqasam.',
  [tikoI18nKeys.radio.share.shareCollection]: 'Aqsam il-kollezzjoni',
  [tikoI18nKeys.radio.import.title]: 'Zid kollezzjoni maqsuma',
  [tikoI18nKeys.radio.import.subtitle]: 'Skennja kodici ta Tiko, jew ikteb it-tmien karattri ta tahtu.',
  [tikoI18nKeys.radio.import.scan]: 'Skennja kodici',
  [tikoI18nKeys.radio.import.scanHint]: 'Zomm il-kodici quddiem il-kamera.',
  [tikoI18nKeys.radio.import.scanUnsupported]: 'Dan il-browser ma jistax jiskennja. Uza l-kamera tat-telefon fuq il-kodici, jew iktbu hawn taht.',
  [tikoI18nKeys.radio.import.cameraBlocked]: 'Il-kamera mhix disponibbli. Ikteb il-kodici minflok.',
  [tikoI18nKeys.radio.import.codeLabel]: 'Kodici tal-qsim',
  [tikoI18nKeys.radio.import.codePlaceholder]: 'ABCD 2345',
  [tikoI18nKeys.radio.import.find]: 'Fittex',
  [tikoI18nKeys.radio.import.notFound]: 'Ma nstabet ebda kollezzjoni ghal dak il-kodici.',
  [tikoI18nKeys.radio.import.featured]: 'Kollezzjonijiet lesti',
  [tikoI18nKeys.radio.import.addCollection]: 'Zid din il-kollezzjoni',
  [tikoI18nKeys.radio.services.title]: 'Servizzi tal-muzika',
  [tikoI18nKeys.radio.services.subtitle]: 'Qabbad abbonament biex izzid il-kanzunetti tieghu ma kollezzjoni.',
  [tikoI18nKeys.radio.services.link]: 'Qabbad',
  [tikoI18nKeys.radio.services.unlink]: 'Aqla',
  [tikoI18nKeys.radio.services.linked]: 'Imqabbad',
  [tikoI18nKeys.radio.services.spotify]: 'Spotify',
  [tikoI18nKeys.radio.services.spotifyHint]: 'Il-kanzunetti jindaqqu f Radju bil-player ta Spotify. Idhol f Spotify f dan il-browser biex tisma l-kanzunetti shah.',
  [tikoI18nKeys.radio.services.appleMusic]: 'Apple Music',
  [tikoI18nKeys.radio.services.appleMusicHint]: 'Il-kanzunetti ta Apple Music jinfethu f Apple Music \u2014 Radju ma jistax idoqqhom hu.',
  [tikoI18nKeys.radio.services.addFrom]: 'Zid minn {service}',
  [tikoI18nKeys.radio.services.opensInService]: 'Jinfetah f {service}',
