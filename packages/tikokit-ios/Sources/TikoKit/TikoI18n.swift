...
enum TikoLocalTranslations {
    static func bundles(for app: TikoAppKey) -> [(String, [String: String])] {
        ...
        case .globe:    return globeBundles
        }
    }
    ...
    private static let radioEN: [String: String] = [
        ...
        "radio.collections.name": "Collection name",
        "radio.collections.artwork": "Picture",
        "radio.collections.artworkSearch": "Search Tiko pictures",
        "radio.collections.artworkEmpty": "No pictures found",
        "radio.collections.color": "Colour",
        "radio.add.menuTitle": "What do you want to add?",
        "radio.add.song": "Add song",
        "radio.add.collection": "Add collection",
        "radio.add.searchYouTube": "Search YouTube",
        "radio.add.searchPlaceholder": "Search for songs, stories\u{2026}",
        "radio.add.searchEmpty": "Nothing found. Try other words.",
        "radio.add.searchUnavailable": "Search is unavailable right now \u{2014} paste a link instead.",
        "radio.add.pasteLink": "Paste a YouTube link",
        "radio.add.pasteServiceLink": "Paste a song link",
        "radio.add.uploadTitle": "Upload audio",
        "radio.add.chooseFile": "Tap to choose an audio file",
        "radio.add.toCollection": "Add to {collection}",
        "radio.add.audioOnly": "Only the sound plays \u{2014} the video stays hidden.",
        "radio.add.linkNotRecognised": "That link is not a song Radio can play.",
        "radio.management.editCollection": "Edit collection",
        "radio.management.deleteCollectionWarning": "Deleting \u{201C}{collection}\u{201D} also removes its {count} songs.",
        "radio.management.deleteCollectionWarningEmpty": "Delete \u{201C}{collection}\u{201D}?",
        "radio.management.collectionActions": "Collection options",
        "radio.share.title": "Share this collection",
        "radio.share.subtitle": "Let another family scan this, or read them the code.",
        "radio.share.codeLabel": "Share code",
        "radio.share.copyLink": "Copy link",
        "radio.share.shareCollection": "Share collection",
        ...
        "radio.import.featured": "Ready-made collections",
        "radio.import.addCollection": "Add this collection",
        "radio.services.title": "Music services",
        "radio.services.subtitle": "Link a subscription to add its songs to a collection.",
        "radio.services.link": "Link",
        "radio.services.unlink": "Unlink",
        "radio.services.linked": "Linked",
        "radio.services.spotifyHint": "Songs play in Radio through Spotify\u{2019}s own player. Sign in to Spotify in this browser to hear full songs instead of previews.",
        "radio.services.appleMusicHint": "Apple Music songs open in Apple Music \u{2014} Radio cannot play them itself.",
        "radio.services.addFrom": "Add from {service}",
        "radio.services.opensInService": "Opens in {service}",
    ...
    private static let yesNoEN: [String: String] = [
        ...
        "yesNo.sheet.newSet": "New answer set",
        "yesNo.sheet.editSet": "Edit answer set",
        "yesNo.sheet.setName": "Set name",
        "yesNo.sheet.setNamePlaceholder": "Name this set",
        "yesNo.sheet.description": "Description",
        "yesNo.sheet.descriptionPlaceholder": "Optional description",
        "yesNo.sheet.color": "Color",
        "yesNo.sheet.image": "Image",
        "yesNo.sheet.changeImage": "Change image",
        "yesNo.sheet.addImage": "Add image",
        "yesNo.sheet.pickImage": "Choose image",
        "yesNo.sheet.search": "Search",
        "yesNo.sheet.searching": "Searching…",
        "yesNo.sheet.searchImages": "Search images",
        "yesNo.sheet.typeToSearch": "Type to search for images",
        "yesNo.sheet.cancel": "Cancel",
        "yesNo.sheet.addSet": "Add set",
        "yesNo.sheet.tiles": "Tiles",
        "yesNo.sheet.tilesEmpty": "No tiles yet. Add one to build the set.",
        "yesNo.sheet.tileCount": "tiles",
        "yesNo.sheet.select": "Use this set",
        "yesNo.sheet.delete": "Delete",
        "yesNo.sheet.readonlySet": "This is a built-in set. Create your own set to edit tiles.",
        "yesNo.sheet.newTile": "New answer",
        "yesNo.sheet.editTile": "Edit answer",
        "yesNo.sheet.name": "Answer",
        "yesNo.sheet.namePlaceholder": "What to display",
        "yesNo.sheet.spokenText": "Spoken text",
        "yesNo.sheet.whatShouldBeSpoken": "What to say when tapped",
        "common.cancel": "Cancel",
        "common.save": "Save",
        "common.settings": "Settings",
    ]
