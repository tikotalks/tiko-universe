...
/** Bosnian overlay: Croatian's structure, with Bosnian words where they differ. */
export const bosnianLexicon: Lexicon = {
  ...
  bread: { pos: 'noun', gender: 'masculine', mass: true, cases: { gen: 'hljeba' } },
