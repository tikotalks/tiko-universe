...
export const englishLexicon: Lexicon = {
  ...
  // Irregular pasts the old code hid: it fell back to the bare stem, so "he ran"
  // came out as "he run". Now that a rule spells the regular ones, these show.
  hear: { pos: 'verb', forms: { past: 'heard' } },
  come: { pos: 'verb', forms: { past: 'came' } },
  draw: { pos: 'verb', forms: { past: 'drew' } },
  sit: { pos: 'verb', forms: { past: 'sat' } },
  stand: { pos: 'verb', forms: { past: 'stood' } },
  run: { pos: 'verb', forms: { past: 'ran' } },
  choose: { pos: 'verb', forms: { past: 'chose' } },
  ...
  // The verbs added in the core rebalance. Only the irregular pasts need stating;
  // the present tense follows from the rule, including "catches" and "cries".
  get: { pos: 'verb', forms: { past: 'got' } },
  give: { pos: 'verb', forms: { past: 'gave' } },
  put: { pos: 'verb', forms: { past: 'put' } },
  take: { pos: 'verb', forms: { past: 'took' } },
  make: { pos: 'verb', forms: { past: 'made' } },
  know: { pos: 'verb', forms: { past: 'knew' } },
  find: { pos: 'verb', forms: { past: 'found' } },
  think: { pos: 'verb', forms: { past: 'thought' } },
  tell: { pos: 'verb', forms: { past: 'told' } },
  show: { pos: 'verb', forms: { past: 'showed' } },
  hold: { pos: 'verb', forms: { past: 'held' } },
  write: { pos: 'verb', forms: { past: 'wrote' } },
  let: { pos: 'verb', forms: { past: 'let' } },
  cut: { pos: 'verb', forms: { past: 'cut' } },
  build: { pos: 'verb', forms: { past: 'built' } },
  swim: { pos: 'verb', forms: { past: 'swam' } },
  ride: { pos: 'verb', forms: { past: 'rode' } },
  throw: { pos: 'verb', forms: { past: 'threw' } },
  catch: { pos: 'verb', forms: { past: 'caught' } },
  sing: { pos: 'verb', forms: { past: 'sang' } },
  wake: { pos: 'verb', forms: { past: 'woke' } },
  smell: { pos: 'verb', forms: { past: 'smelled' } },
  ...
  soup: { pos: 'noun', mass: true },
  yogurt: { pos: 'noun', mass: true },
  pasta: { pos: 'noun', mass: true },
  lemonade: { pos: 'noun', mass: true },
  cereal: { pos: 'noun', mass: true },
