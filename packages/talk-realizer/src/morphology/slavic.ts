 ...
 * genitive, dative, locative and instrumental, the cases Talk's sentence shapes
 * produce. The vocative is not generated.
 */

export type SlavicLanguage = 'ru' | 'pl' | 'uk' | 'sr' | 'hr' | 'bs' | 'cs' | 'sk' | 'sl' | 'be' | 'lt' | 'lv' | 'cnr'
export type SlavicCase = 'nom' | 'acc' | 'gen' | 'dat' | 'loc' | 'ins'
...
const DECLENSIONS: Record<SlavicLanguage, Record<NounClass, ClassEndings>> = {
  ru: {
    'fem-a': { acc: { strip: 1, add: 'у' }, gen: { strip: 1, add: 'ы' }, dat: { strip: 1, add: 'е' }, loc: { strip: 1, add: 'е' } , ins: { strip: 1, add: 'ой' } },
    'fem-ja': { acc: { strip: 1, add: 'ю' }, gen: { strip: 1, add: 'и' }, dat: { strip: 1, add: 'е' }, loc: { strip: 1, add: 'е' } , ins: { strip: 1, add: 'ей' } },
    'fem-soft': { acc: 'nominative', gen: { strip: 1, add: 'и' }, dat: { strip: 1, add: 'и' }, loc: { strip: 1, add: 'и' } , ins: { strip: 1, add: 'ой' } },
    'neut-o': { acc: 'nominative', gen: { strip: 1, add: 'а' }, dat: { strip: 1, add: 'у' }, loc: { strip: 1, add: 'е' } , ins: { strip: 1, add: 'ом' } },
    'neut-e': { acc: 'nominative', gen: { strip: 1, add: 'я' }, dat: { strip: 1, add: 'ю' }, loc: { strip: 1, add: 'е' } , ins: { strip: 1, add: 'ом' } },
    'masc-hard': { acc: 'nominative', gen: { add: 'а' }, dat: { add: 'у' }, loc: { add: 'е' } , ins: { add: 'ом' } },
    'masc-soft': { acc: 'nominative', gen: { strip: 1, add: 'я' }, dat: { strip: 1, add: 'ю' }, loc: { strip: 1, add: 'е' } , ins: { add: 'ом' } },
    'masc-j': { acc: 'nominative', gen: { strip: 1, add: 'я' }, dat: { strip: 1, add: 'ю' }, loc: { strip: 1, add: 'е' } , ins: { add: 'ом' } },
  },
  pl: {
    'fem-a': { acc: { strip: 1, add: 'ę' }, gen: { strip: 1, add: 'y' }, dat: { strip: 1, add: 'ie' }, loc: { strip: 1, add: 'ie' } , ins: { strip: 1, add: 'ą' } },
    'fem-ja': { acc: { strip: 1, add: 'ę' }, gen: { strip: 1, add: 'i' }, dat: { strip: 1, add: 'i' }, loc: { strip: 1, add: 'i' } , ins: { strip: 1, add: 'ą' } },
    'fem-soft': { acc: 'nominative', gen: { strip: 1, add: 'y' }, dat: { strip: 1, add: 'y' }, loc: { strip: 1, add: 'y' } , ins: { strip: 1, add: 'ą' } },
    'neut-o': { acc: 'nominative', gen: { strip: 1, add: 'a' }, dat: { strip: 1, add: 'u' }, loc: { strip: 1, add: 'u' } , ins: { strip: 1, add: 'em' } },
    'neut-e': { acc: 'nominative', gen: { strip: 1, add: 'a' }, dat: { strip: 1, add: 'u' }, loc: { strip: 1, add: 'u' } , ins: { strip: 1, add: 'em' } },
    'masc-hard': { acc: 'nominative', gen: { add: 'a' }, dat: { add: 'owi' }, loc: { add: 'u' } , ins: { add: 'em' } },
    'masc-soft': { acc: 'nominative', gen: { strip: 1, add: 'a' }, dat: { strip: 1, add: 'owi' }, loc: { strip: 1, add: 'u' } , ins: { add: 'em' } },
    'masc-j': { acc: 'nominative', gen: { strip: 1, add: 'a' }, dat: { strip: 1, add: 'owi' }, loc: { strip: 1, add: 'u' } , ins: { add: 'em' } },
  },
  uk: {
    'fem-a': { acc: { strip: 1, add: 'у' }, gen: { strip: 1, add: 'и' }, dat: { strip: 1, add: 'і' }, loc: { strip: 1, add: 'і' } , ins: { strip: 1, add: 'ою' } },
    'fem-ja': { acc: { strip: 1, add: 'ю' }, gen: { strip: 1, add: 'і' }, dat: { strip: 1, add: 'і' }, loc: { strip: 1, add: 'і' } , ins: { strip: 1, add: 'ею' } },
    'fem-soft': { acc: 'nominative', gen: { strip: 1, add: 'і' }, dat: { strip: 1, add: 'і' }, loc: { strip: 1, add: 'і' } , ins: { strip: 1, add: 'ою' } },
    'neut-o': { acc: 'nominative', gen: { strip: 1, add: 'а' }, dat: { strip: 1, add: 'у' }, loc: { strip: 1, add: 'і' } , ins: { strip: 1, add: 'ом' } },
    'neut-e': { acc: 'nominative', gen: { strip: 1, add: 'я' }, dat: { strip: 1, add: 'ю' }, loc: { strip: 1, add: 'і' } , ins: { strip: 1, add: 'ом' } },
    'masc-hard': { acc: 'nominative', gen: { add: 'а' }, dat: { add: 'у' }, loc: { add: 'і' } , ins: { add: 'ом' } },
    'masc-soft': { acc: 'nominative', gen: { strip: 1, add: 'я' }, dat: { strip: 1, add: 'ю' }, loc: { strip: 1, add: 'і' } , ins: { add: 'ом' } },
    'masc-j': { acc: 'nominative', gen: { strip: 1, add: 'я' }, dat: { strip: 1, add: 'ю' }, loc: { strip: 1, add: 'ї' } , ins: { add: 'ом' } },
  },
  sr: {
    'fem-a': { acc: { strip: 1, add: 'у' }, gen: { strip: 1, add: 'е' }, dat: { strip: 1, add: 'и' }, loc: { strip: 1, add: 'и' } , ins: { strip: 1, add: 'ом' } },
    'fem-ja': { acc: { strip: 1, add: 'у' }, gen: { strip: 1, add: 'е' }, dat: { strip: 1, add: 'и' }, loc: { strip: 1, add: 'и' } , ins: { strip: 1, add: 'ом' } },
    'fem-soft': { acc: 'nominative', gen: { add: 'и' }, dat: { add: 'и' }, loc: { add: 'и' } , ins: { strip: 1, add: 'ом' } },
    'neut-o': { acc: 'nominative', gen: { strip: 1, add: 'а' }, dat: { strip: 1, add: 'у' }, loc: { strip: 1, add: 'у' } , ins: { strip: 1, add: 'ом' } },
    'neut-e': { acc: 'nominative', gen: { strip: 1, add: 'а' }, dat: { strip: 1, add: 'у' }, loc: { strip: 1, add: 'у' } , ins: { strip: 1, add: 'ом' } },
    'masc-hard': { acc: 'nominative', gen: { add: 'а' }, dat: { add: 'у' }, loc: { add: 'у' } , ins: { add: 'ом' } },
    'masc-soft': { acc: 'nominative', gen: { add: 'а' }, dat: { add: 'у' }, loc: { add: 'у' } , ins: { add: 'ом' } },
    'masc-j': { acc: 'nominative', gen: { strip: 1, add: 'а' }, dat: { strip: 1, add: 'у' }, loc: { strip: 1, add: 'у' } , ins: { add: 'ом' } },
  },
  hr: {
    'fem-a': { acc: { strip: 1, add: 'u' }, gen: { strip: 1, add: 'e' }, dat: { strip: 1, add: 'i' }, loc: { strip: 1, add: 'i' } , ins: { strip: 1, add: 'om' } },
    'fem-ja': { acc: { strip: 1, add: 'u' }, gen: { strip: 1, add: 'e' }, dat: { strip: 1, add: 'i' }, loc: { strip: 1, add: 'i' } , ins: { strip: 1, add: 'om' } },
    'fem-soft': { acc: 'nominative', gen: { add: 'i' }, dat: { add: 'i' }, loc: { add: 'i' } , ins: { strip: 1, add: 'om' } },
    'neut-o': { acc: 'nominative', gen: { strip: 1, add: 'a' }, dat: { strip: 1, add: 'u' }, loc: { strip: 1, add: 'u' } , ins: { strip: 1, add: 'om' } },
    'neut-e': { acc: 'nominative', gen: { strip: 1, add: 'a' }, dat: { strip: 1, add: 'u' }, loc: { strip: 1, add: 'u' } , ins: { strip: 1, add: 'om' } },
    'masc-hard': { acc: 'nominative', gen: { add: 'a' }, dat: { add: 'u' }, loc: { add: 'u' } , ins: { add: 'om' } },
    'masc-soft': { acc: 'nominative', gen: { add: 'a' }, dat: { add: 'u' }, loc: { add: 'u' } , ins: { add: 'om' } },
    'masc-j': { acc: 'nominative', gen: { strip: 1, add: 'a' }, dat: { strip: 1, add: 'u' }, loc: { strip: 1, add: 'u' } , ins: { add: 'om' } },
  },
  cs: {
    'fem-a': { acc: { strip: 1, add: 'u' }, gen: { strip: 1, add: 'y' }, dat: { strip: 1, add: 'ě' }, loc: { strip: 1, add: 'ě' } , ins: { strip: 1, add: 'ou' } },
    'fem-ja': { acc: { strip: 1, add: 'i' }, gen: { strip: 1, add: 'e' }, dat: { strip: 1, add: 'i' }, loc: { strip: 1, add: 'i' } , ins: { strip: 1, add: 'í' } },
    'fem-soft': { acc: 'nominative', gen: { add: 'i' }, dat: { add: 'i' }, loc: { add: 'i' } , ins: { strip: 1, add: 'ou' } },
    'neut-o': { acc: 'nominative', gen: { strip: 1, add: 'a' }, dat: { strip: 1, add: 'u' }, loc: { strip: 1, add: 'u' } , ins: { strip: 1, add: 'em' } },
    'neut-e': { acc: 'nominative', gen: { strip: 1, add: 'e' }, dat: { strip: 1, add: 'i' }, loc: { strip: 1, add: 'i' } , ins: { strip: 1, add: 'em' } },
    'masc-hard': { acc: 'nominative', gen: { add: 'u' }, dat: { add: 'u' }, loc: { add: 'u' } , ins: { add: 'em' } },
    'masc-soft': { acc: 'nominative', gen: { add: 'e' }, dat: { add: 'i' }, loc: { add: 'i' } , ins: { add: 'em' } },
    'masc-j': { acc: 'nominative', gen: { strip: 1, add: 'e' }, dat: { strip: 1, add: 'i' }, loc: { strip: 1, add: 'i' } , ins: { add: 'em' } },
  },
  sk: {
    'fem-a': { acc: { strip: 1, add: 'u' }, gen: { strip: 1, add: 'y' }, dat: { strip: 1, add: 'e' }, loc: { strip: 1, add: 'e' } , ins: { strip: 1, add: 'ou' } },
    'fem-ja': { acc: { strip: 1, add: 'u' }, gen: { strip: 1, add: 'e' }, dat: { strip: 1, add: 'i' }, loc: { strip: 1, add: 'i' } , ins: { strip: 1, add: 'ou' } },
    'fem-soft': { acc: 'nominative', gen: { add: 'i' }, dat: { add: 'i' }, loc: { add: 'i' } , ins: { strip: 1, add: 'ou' } },
    'neut-o': { acc: 'nominative', gen: { strip: 1, add: 'a' }, dat: { strip: 1, add: 'u' }, loc: { strip: 1, add: 'u' } , ins: { strip: 1, add: 'om' } },
    'neut-e': { acc: 'nominative', gen: { strip: 1, add: 'a' }, dat: { strip: 1, add: 'u' }, loc: { strip: 1, add: 'u' } , ins: { strip: 1, add: 'om' } },
    'masc-hard': { acc: 'nominative', gen: { add: 'u' }, dat: { add: 'u' }, loc: { add: 'u' } , ins: { add: 'om' } },
    'masc-soft': { acc: 'nominative', gen: { add: 'a' }, dat: { add: 'ovi' }, loc: { add: 'ovi' } , ins: { add: 'om' } },
    'masc-j': { acc: 'nominative', gen: { strip: 1, add: 'a' }, dat: { strip: 1, add: 'ovi' }, loc: { strip: 1, add: 'ovi' } , ins: { add: 'om' } },
  },
  sl: {
    'fem-a': { acc: { strip: 1, add: 'o' }, gen: { strip: 1, add: 'e' }, dat: { strip: 1, add: 'i' }, loc: { strip: 1, add: 'i' } , ins: { strip: 1, add: 'o' } },
    'fem-ja': { acc: { strip: 1, add: 'o' }, gen: { strip: 1, add: 'e' }, dat: { strip: 1, add: 'i' }, loc: { strip: 1, add: 'i' } , ins: { strip: 1, add: 'o' } },
    'fem-soft': { acc: 'nominative', gen: { add: 'i' }, dat: { add: 'i' }, loc: { add: 'i' } , ins: { strip: 1, add: 'o' } },
    'neut-o': { acc: 'nominative', gen: { strip: 1, add: 'a' }, dat: { strip: 1, add: 'u' }, loc: { strip: 1, add: 'u' } , ins: { strip: 1, add: 'om' } },
    'neut-e': { acc: 'nominative', gen: { strip: 1, add: 'a' }, dat: { strip: 1, add: 'u' }, loc: { strip: 1, add: 'u' } , ins: { strip: 1, add: 'om' } },
    'masc-hard': { acc: 'nominative', gen: { add: 'a' }, dat: { add: 'u' }, loc: { add: 'u' } , ins: { add: 'om' } },
    'masc-soft': { acc: 'nominative', gen: { add: 'a' }, dat: { add: 'u' }, loc: { add: 'u' } , ins: { add: 'om' } },
  ...
  be: {
    'fem-a': { acc: { strip: 1, add: 'у' }, gen: { strip: 1, add: 'ы' }, dat: { strip: 1, add: 'е' }, loc: { strip: 1, add: 'е' } , ins: { strip: 1, add: 'ой' } },
    'fem-ja': { acc: { strip: 1, add: 'ю' }, gen: { strip: 1, add: 'і' }, dat: { strip: 1, add: 'і' }, loc: { strip: 1, add: 'і' } , ins: { strip: 1, add: 'ёй' } },
    'fem-soft': { acc: 'nominative', gen: { strip: 1, add: 'і' }, dat: { strip: 1, add: 'і' }, loc: { strip: 1, add: 'і' } , ins: { strip: 1, add: 'ой' } },
    'neut-o': { acc: 'nominative', gen: { strip: 1, add: 'а' }, dat: { strip: 1, add: 'у' }, loc: { strip: 1, add: 'е' } , ins: { strip: 1, add: 'ам' } },
    'neut-e': { acc: 'nominative', gen: { strip: 1, add: 'я' }, dat: { strip: 1, add: 'ю' }, loc: { strip: 1, add: 'і' } , ins: { strip: 1, add: 'ам' } },
    'masc-hard': { acc: 'nominative', gen: { add: 'а' }, dat: { add: 'у' }, loc: { add: 'е' } , ins: { add: 'ам' } },
    'masc-soft': { acc: 'nominative', gen: { strip: 1, add: 'я' }, dat: { strip: 1, add: 'ю' }, loc: { strip: 1, add: 'і' } , ins: { add: 'ам' } },
    'masc-j': { acc: 'nominative', gen: { strip: 1, add: 'я' }, dat: { strip: 1, add: 'ю' }, loc: { strip: 1, add: 'і' } , ins: { add: 'ам' } },
  },
  lt: {
    // Lithuanian: -as/-is/-us for masculines, -a/-ė for feminines.
    'fem-a': { acc: { strip: 1, add: 'ą' }, gen: { strip: 1, add: 'os' }, dat: { strip: 1, add: 'ai' }, loc: { strip: 1, add: 'oje' } , ins: { strip: 1, add: 'a' } },
    'fem-ja': { acc: { strip: 1, add: 'ę' }, gen: { strip: 1, add: 'ės' }, dat: { strip: 1, add: 'ei' }, loc: { strip: 1, add: 'ėje' } , ins: { strip: 1, add: 'e' } },
    'fem-soft': { acc: { strip: 1, add: 'į' }, gen: { strip: 1, add: 'ies' }, dat: { strip: 1, add: 'iai' }, loc: { strip: 1, add: 'yje' } , ins: { strip: 1, add: 'a' } },
    'neut-o': { acc: 'nominative', gen: { add: 'o' }, dat: { add: 'ui' }, loc: { add: 'e' } , ins: { add: 'u' } },
    'neut-e': { acc: 'nominative', gen: { add: 'o' }, dat: { add: 'ui' }, loc: { add: 'e' } , ins: { add: 'u' } },
    'masc-hard': { acc: { strip: 2, add: 'ą' }, gen: { strip: 2, add: 'o' }, dat: { strip: 2, add: 'ui' }, loc: { strip: 2, add: 'e' } , ins: { strip: 2, add: 'u' } },
    'masc-soft': { acc: { strip: 2, add: 'į' }, gen: { strip: 2, add: 'io' }, dat: { strip: 2, add: 'iui' }, loc: { strip: 2, add: 'yje' } , ins: { strip: 2, add: 'u' } },
    'masc-j': { acc: { strip: 2, add: 'ų' }, gen: { strip: 2, add: 'aus' }, dat: { strip: 2, add: 'ui' }, loc: { strip: 2, add: 'uje' } , ins: { strip: 2, add: 'u' } },
  },
  lv: {
    // Latvian: -s/-is for masculines, -a/-e for feminines.
    'fem-a': { acc: { strip: 1, add: 'u' }, gen: { strip: 1, add: 'as' }, dat: { strip: 1, add: 'ai' }, loc: { strip: 1, add: 'ā' } , ins: { strip: 1, add: 'u' } },
    'fem-ja': { acc: { strip: 1, add: 'i' }, gen: { strip: 1, add: 'es' }, dat: { strip: 1, add: 'ei' }, loc: { strip: 1, add: 'ē' } , ins: { strip: 1, add: 'i' } },
    'fem-soft': { acc: { strip: 1, add: 'i' }, gen: { strip: 1, add: 's' }, dat: { strip: 1, add: 'ij' }, loc: { strip: 1, add: 'ī' } , ins: { strip: 1, add: 'u' } },
    'neut-o': { acc: 'nominative', gen: { add: 'a' }, dat: { add: 'am' }, loc: { add: 'ā' } , ins: { strip: 1, add: 'u' } },
    'neut-e': { acc: 'nominative', gen: { add: 'a' }, dat: { add: 'am' }, loc: { add: 'ā' } , ins: { strip: 1, add: 'u' } },
    'masc-hard': { acc: { strip: 1, add: 'u' }, gen: { strip: 1, add: 'a' }, dat: { strip: 1, add: 'am' }, loc: { strip: 1, add: 'ā' } , ins: { strip: 1, add: 'u' } },
    'masc-soft': { acc: { strip: 2, add: 'i' }, gen: { strip: 2, add: 'a' }, dat: { strip: 2, add: 'im' }, loc: { strip: 2, add: 'ī' } , ins: { strip: 1, add: 'u' } },
    'masc-j': { acc: { strip: 1, add: 'u' }, gen: { strip: 1, add: 'a' }, dat: { strip: 1, add: 'am' }, loc: { strip: 1, add: 'ā' } , ins: { strip: 1, add: 'u' } },
  },}
